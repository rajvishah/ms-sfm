...
echo $binPath/matcher3d_2d $bundlePath $listPath $outPath/queries.txt $rankDir/all_ranks_sorted.txt $outPath/correspondences -1 50 >> $outPath/run_own_localization.sh
