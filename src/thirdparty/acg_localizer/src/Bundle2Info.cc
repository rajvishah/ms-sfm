...
int main (int argc, char **argv)
{
  ...
  clock_t bundle_read_start = clock();
  ...
  clock_t bundle_read_stop = clock();
  printf("[BUNDLE2INFO] Parsing Bundle took %0.3fs\n", 
          (bundle_read_stop - bundle_read_start) / ((double) CLOCKS_PER_SEC));
  ...
  clock_t para_point_start = clock();
  ...
  clock_t para_point_stop = clock();
  printf("[BUNDLE2INFO] Point Statistics took %0.3fs\n", 
          (para_point_stop - para_point_start) / ((double) CLOCKS_PER_SEC));
  
  printf("[BUNDLE2INFO] Point Statistics per point would take (OMP) %0.3fs, %d Points\n", 
          (para_point_stop - para_point_start) / ((double) CLOCKS_PER_SEC * (double)nb_points), nb_points);
  ...
  clock_t para_cam_stop = clock();
  printf("[BUNDLE2INFO] Camera Statistics per cam would take (OMP) %0.3fs, %d Cameras\n", 
          (para_cam_stop - para_cam_start) / ((double) CLOCKS_PER_SEC * (double)nb_cameras), nb_cameras);
  ...
  clock_t info_write_start = clock();
  ...
  ofs.close();
  clock_t info_write_stop = clock();
  printf("[BUNDLE2INFO] Writing info would take %0.3fs\n", 
          (info_write_stop - info_write_start) / ((double) CLOCKS_PER_SEC));
  std::cout << "--> done" << std::endl;
  std::cout << "--> done writing info file" << std::endl;
