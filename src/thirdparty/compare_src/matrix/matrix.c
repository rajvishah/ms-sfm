...
/* Compute the pseudoinverse of a matrix of rank 'rank' */
void matrix_pseudoinverse(int n, int rank, double *A, double *R)
{
    double *U, *S, *Sinv, *VT, *tmp;
    int i;

    U = (double *) malloc(sizeof(double) * n * n);
    S = (double *) malloc(sizeof(double) * n);
    VT = (double *) malloc(sizeof(double) * n * n);
    Sinv = (double *) malloc(sizeof(double) * n * n);
    tmp = (double *) malloc(sizeof(double) * n * n);

    dgesvd_driver(n, n, A, U, S, VT);
    ...
    matrix_transpose_product(n, n, n, n, VT, Sinv, tmp);
    matrix_transpose_product2(n, n, n, n, tmp, U, R);
