...
BASE_PATH=/home/cvit/rajvi/bundler/
...
MATCHKEYS=$BASE_PATH/bin/multiscale_mg
...
sleep 1
echo $MATCHKEYS --keyfile_list=list_keys.txt --matches_file=matches.init.txt 
$MATCHKEYS --keyfile_list=list_keys.txt --matches_file=matches.init.txt
